                      ...
                      <div class="row">
                        <div class="col-md-12">
                          <div class="about-box-content">
                            <a href="/about-image.png" data-lightbox="image-1">
                            <img src="<?php echo get_theme_file_uri() ?>/img/about-image.png" alt=""></a>
                          </div>
                        </div>
                          ...
                          <div class="owl-carousel owl-theme projects-container">
                            <div>
                              <div class="price-item">
                                <a href="price-item-01.jpg" data-lightbox="image-1"><img src="<?php echo get_theme_file_uri() ?>/img/price-item-01.jpg" alt=""></a>
                            ...
                            <div>
                              <div class="price-item">
                                <a href="img/price-item-02.jpg" data-lightbox="image-1"><img src="<?php echo get_theme_file_uri() ?>/img/price-item-02.jpg" alt=""></a>
                                <div class="text-content">
                                  <h4>Boxeo</h4>
                            ...
                            <div>
                              <div class="price-item">
                                <a href="img/price-item-03.jpg" data-lightbox="image-1"><img src="<?php echo get_theme_file_uri() ?>/img/price-item-03.jpg" alt=""></a>
                                <div class="text-content">
                                  <h4>Crossfit</h4>
                            ...
                            <div>
                              <div class="price-item">
                                <a href="img/price-item-04.jpg" data-lightbox="image-1"><img src="<?php echo get_theme_file_uri() ?>/img/price-item-04.jpg" alt=""></a>
                                <div class="text-content">
                                  <h4>JIU-JITSU</h4>
                            ...
                            <div>
                              <div class="price-item">
                                <a href="img/price-item-05.jpg" data-lightbox="image-1"><img src="<?php echo get_theme_file_uri() ?>/img/price-item-05.jpg" alt=""></a>
                                <div class="text-content">
                                  <h4>Fitbox</h4>
                            ...
                            <div>
                              <div class="price-item">
                                <a href="img/price-item-06.jpg" data-lightbox="image-1"><img src="
                                  <?php echo get_theme_file_uri() ?>/img/price-item-06.jpg" alt=""></a>
                                <div class="text-content">
                                  <h4>Zumba</h4>
                            ...
                            <div>
                              <div class="price-item">
                                <a href="img/price-item-07.jpg" data-lightbox="image-1"><img src="<?php echo get_theme_file_uri()?>/img/price-item-07.jpg" alt=""></a>
                                <div class="text-content">
                                  <h4>Baby Fútbol</h4>
